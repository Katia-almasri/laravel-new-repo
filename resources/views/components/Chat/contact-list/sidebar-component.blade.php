<header class="p-4 border-b border-gray-300 flex justify-between items-center bg-indigo-600 text-white">
    ...
    <div class="relative">
        ...
        <div id="menuDropdown"
            ...
            <ul class="py-2 px-3">
                <li><a href="#" id="create-new-group-btn"
                        class="block px-4 py-2 text-gray-800 hover:text-gray-400">+ Group</a></li>
                <li><a href="#" id="create-new-chat-btn"
                        class="block px-4 py-2 text-gray-800 hover:text-gray-400">+ Chat</a></li>
